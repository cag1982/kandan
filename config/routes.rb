Kandan::Application.routes.draw do
  ...
  get "/add_user_to_channel/:user_channel"  => "apis#add_user_to_channel", :as => "add_user_to_channel"
  get "/remove_user_from_channel/:user_channel"  => "apis#remove_user_from_channel", :as => "remove_user_from_channel"
